...
## URLs
Urls should be in the form of `http://localhost:8080/gh/<gh-username>/<gh-token>/<owner>/<repo>/pulls/<pull>.svg`

For example: `http://localhost:8080/gh/xadn/<gh-token>/pivotaltracker/tracker-frontend/pulls/97.svg`
